...
export function PointwiseChart({
  pre_post_index,
  point_effects_means,
  point_effects_lower,
  point_effects_upper,
  ...
  const confidence = point_effects_upper.concat(
    point_effects_lower.slice().reverse()
  );
  ...
  const effects_series = {
    x: dates,
    y: point_effects_means,
    line: { color: "rgb(0,176,246)" },
    mode: "lines",
    name: "Effects",
    type: "scatter",
  };
  const data = [confidence_series, effects_series];
